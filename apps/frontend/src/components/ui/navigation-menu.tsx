...
function NavigationMenuLink({
  ...
  return (
    <NavigationMenuPrimitive.Link
      ...
      className={cn(
        "data-[active=true]:text-accent-foreground hover:text-accent-foreground focus:text-accent-foreground focus-visible:ring-ring/50 [&_svg:not([class*='text-'])]:text-muted-foreground flex flex-col gap-1 rounded-sm p-2 text-sm outline-none transition-all hover:bg-gray-100 focus:bg-gray-100 focus-visible:outline-1 focus-visible:ring data-[active=true]:bg-gray-100/50 data-[active=true]:hover:bg-gray-100 data-[active=true]:focus:bg-gray-100 [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}
    />
