...
authorUrl: https://x.com/samdotdev
...
<Link to="/tech/$techKey" params={{ techKey: 'nextjs' }}>
  <Image src="/website/nextjs.png" alt="Next.js Framework" />
</Link>

<TechSummary volume="1.1K" percentChange={'+0.2'} stars="132K" tech="nextjs" />
...
<div>For example, Next.js is used in major repositories such as <BadgeRepo avatar_url="https://avatars.githubusercontent.com/u/59452120?v=4" name="excalidraw" org="excalidraw" /> and <BadgeRepo avatar_url="https://avatars.githubusercontent.com/u/130738209?v=4" name="AutoGPT" org="Significant-Gravitas" />.</div>
...
<Link to="/tech/$techKey" params={{ techKey: 'nextjs' }}>
  <Button>More about Next.js</Button>
</Link>

<HTop position={2} tech="nuxtjs">Nuxt.js</HTop>

<Link to="/tech/$techKey" params={{ techKey: 'nuxtjs' }}>
  <Image src="/website/nuxtjs.png" alt="Nuxt.js Framework" />
</Link>

<TechSummary volume="150" percentChange={'-0.7'} stars="57K" tech="nuxtjs" />
...
<Link to="/tech/$techKey" params={{ techKey: 'nuxtjs' }}>
  <Button>More about Nuxt.js</Button>
</Link>

<HTop position={3} tech="nestjs">NestJS</HTop>

<Link to="/tech/$techKey" params={{ techKey: 'nestjs' }}>
  <Image src="/website/nestjs.png" alt="NestJS Framework" />
</Link>

<TechSummary volume="91" percentChange={'0'} stars="71K" tech="nestjs" />
...
<Link to="/tech/$techKey" params={{ techKey: 'nestjs' }}>
  <Button>More about NestJS</Button>
</Link>

<HTop position={4} tech="remixrun">Remix</HTop>

<Link to="/tech/$techKey" params={{ techKey: 'remixrun' }}>
  <Image src="/website/remixrun.png" alt="Remix Framework" />
</Link>

<TechSummary volume="58" percentChange={'0'} stars="31K" tech="remixrun" />
...
<Link to="/tech/$techKey" params={{ techKey: 'remixrun' }}>
  <Button>More about Remix</Button>
</Link>

<HTop position={5} tech="tanstackstart">TanStack Start</HTop>

<Link to="/tech/$techKey" params={{ techKey: 'tanstackstart' }}>
  <Image src="/website/tanstackstart.png" alt="TanStack Start Framework" />
</Link>

<TechSummary volume="13" percentChange={'+8.3'} stars="10K" tech="tanstackstart" />
...
<Link to="/tech/$techKey" params={{ techKey: 'tanstackstart' }}>
  <Button>More about TanStack Start</Button>
</Link>

<HTop position={6} tech="meteorjs">Meteor.js</HTop>

<Link to="/tech/$techKey" params={{ techKey: 'meteorjs' }}>
  <Image src="/website/meteorjs.png" alt="Meteor.js Framework" />
</Link>

<TechSummary volume="12" percentChange={'+20'} stars="44K" tech="meteorjs" />
...
<Link to="/tech/$techKey" params={{ techKey: 'meteorjs' }}>
  <Button>More about Meteor.js</Button>
</Link>

<HTop position={7} tech="sveltejs">SvelteKit</HTop>

<Link to="/tech/$techKey" params={{ techKey: 'sveltejs' }}>
  <Image src="/website/sveltejs.png" alt="SvelteKit Framework" />
</Link>
...
<Link to="/tech/$techKey" params={{ techKey: 'sveltejs' }}>
  <Button>More about SvelteKit</Button>
</Link>
